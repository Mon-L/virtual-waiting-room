...
import cn.zcn.virtual.waiting.room.domain.exception.InvalidQueueIdException;
 ...
 */
@Component
public class QueueAbility {

    @Resource
    private QueueGateway queueGateway;

    public Queue checkAndGet(String queueId) throws InvalidQueueIdException {
        Queue queue = queueGateway.getQueueByQueueId(queueId);
        if (queue != null) {
            return queue;
        }
