 ...
 */
@Mapper
public interface RequestPositionConverter {

    RequestPositionConverter INSTANCE = Mappers.getMapper(RequestPositionConverter.class);

    RequestPosition poToEntity(RequestPositionPO po);

    RequestPositionPO entityToPO(RequestPosition entity);
}
